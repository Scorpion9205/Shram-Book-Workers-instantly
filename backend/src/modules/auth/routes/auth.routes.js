...
const router = Router();
router.post("/signup", rateLimiter("signup", 3, 15 * 60), AuthController.signup);
router.post("/login", rateLimiter("login", 5, 15 * 60), AuthController.login);
...
router.post("/refresh-token", rateLimiter("signup", 3, 15 * 60), AuthController.refreshToken);
