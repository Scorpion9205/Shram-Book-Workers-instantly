...
const router = Router();
router.post("/", authMiddleware, roleMiddleware("PROVIDER"), rateLimiter("instant:create", 15, 60), InstantRequestController.createInstantRequest);
router.get("/nearby", authMiddleware, roleMiddleware("WORKER"), InstantRequestController.getNearbyRequests);
